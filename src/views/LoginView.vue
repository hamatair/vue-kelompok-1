  ...
  <AuthLayout title="Login" :error="auth.error">
    ...
    <form @submit.prevent="handleLogin" class="space-y-5">
      ...
      <div>
        ...
        <input type="email" v-model="form.email" class="custom-input" required placeholder="email@example.com">
      </div>
      ...
      <div>
        ...
        <div class="relative">
          <input :type="showPassword ? 'text' : 'password'" v-model="form.password" class="custom-input pr-10" required>
    ...
    <div class="text-center mt-6">
      <p class="text-sm font-semibold">
        ...
        <RouterLink to="/register" class="text-orange-500 hover:underline font-bold">Register</RouterLink>
      </p>
    </div>
  </AuthLayout>
</template>
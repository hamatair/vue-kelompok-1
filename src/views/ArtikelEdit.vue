...
onMounted(async () => {
  ...
  if (route.params.id) {
    ...
    if (existingArticle) {
      ...
      if (existingArticle.category && typeof existingArticle.category === 'object') {
        form.value.category_id = existingArticle.category.id
      }else{
        form.value.category_id = existingArticle.category
      }
...
// Handle upload gambar sederhana (Blob 
...
const saveArticle = () => {
  ...
  const payload = {
    // Jika Create, ID biasanya null/undefined tidak masalah
    id: articleId.value,

    // Masukkan field satu per satu agar namanya sesuai permintaan backend
    title: form.value.title,
    content: form.value.content,

    // FIX: Pastikan mengirim 'category_id', ambil dari form.category atau form.category_id
...
<template>
  <div class="min-h-screen bg-gray-50 p-8 font-sans text-gray-800">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Tombol Back -->
      <button @click="cancel"
        class="flex items-center text-black font-bold mb-6 hover:text-orange-500 transition-colors">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <input v-model="form.title" type="text" placeholder="Enter your article title..."
          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div
              class="relative w-full h-64 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center bg-white overflow-hidden group hover:border-orange-400 transition-colors">
              <!-- Preview Gambar -->
              ...
              <div v-if="form.image"
                class="absolute inset-0 bg-black/40 hidden group-hover:flex items-center justify-center z-10 text-white text-sm font-medium">
                Change Image
              </div>
            </div>
          </div>
          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <textarea v-model="form.content"
              ...
              placeholder="Write your article here... (Supports basic HTML tags like <p>, <b>, etc.)"></textarea>
          </div>
        </div>
          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div class="relative">
              <select v-model="form.category_id"
                class="w-full bg-gray-100 rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-orange-500 appearance-none">

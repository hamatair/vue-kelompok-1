...
// Pastikan path import sesuai dengan nama file store kamu
...
const formatDate = (dateString) => {
    ...
    // Pastikan input string bisa diparse Date
    ...
    <div class="min-h-screen bg-gray-50 p-8 font-sans text-gray-800">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-8 flex justify-between items-end">
                ...
                <!-- Tombol Add New -->
                <button @click="router.push('/admin/article/new')"
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm">
                        <thead class="bg-white border-b border-gray-100 text-gray-500 uppercase tracking-wider text-xs">
                            <tr>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <tr v-for="article in articles" :key="article.id"
                                ...
                                <td class="px-6 py-4">
                                    <!-- Badge Status -->
                                    <span class="px-3 py-1 rounded-full text-xs font-medium border capitalize" :class="article.status === 'published'

...
<template>
  <main class="min-h-screen bg-white text-slate-900">
        ...
        <div class="flex justify-center md:justify-end w-full md:w-fit md:ms-auto">
          <div class="relative">
            ...
            <div
              ...
              <img src="../assets/illustration-healthy-food.png" alt="Ilustrasi makanan sehat"
    ...
    <section class="py-14 bg-orange-400 text-white">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-[1.1fr_1.3fr] gap-8 items-center">
        <div>

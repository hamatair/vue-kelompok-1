...
<template>
  <div class="min-h-screen bg-gray-50 font-sans text-gray-800">
    ...
    <div class="py-16 px-30 text-center sm:bg-gray-50 border-b border-gray-200">
      <h1 class="text-3xl md:text-4xl font-medium text-gray-900 mb-3">
        Welcome to CALMATE Blog
      </h1>
          ...
          <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <ul class="space-y-2">
              <li v-for="(cat, index) in categories" :key="index">
                <a href="#" class="flex justify-between items-center px-4 py-2 rounded-lg text-sm transition-colors"
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm text-gray-500">
              ...
              <li><a href="#" class="hover:text-orange-500 transition-colors">Artikel</a></li>
              <li><a href="#" class="hover:text-orange-500 transition-colors">Rekomendasi</a></li>
            </ul>
          </div>
